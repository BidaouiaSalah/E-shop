@extends('layouts.app')
@section('content')
   @include('includes.header', ['pageTitle' => 'Contact'])
   </div>
   </div>
   </div>
   ...
   <div class="container-fluid pt-2">
      ...
      <div class="row px-xl-5">
         ...
         <div class="col-lg-5 mb-5">
            ...
            <p>Justo sed diam ut sed amet duo amet lorem amet stet sea ipsum, sed duo amet et. Est
               elitr dolor elitr erat sit sit. Dolor diam et erat clita ipsum justo sed.</p>
